...
if (candidate.ethereum.contractReferencesObserved !== 1) throw new Error("Protocol deployment reference was not resolved or a spoofed Etherscan-shaped URL was accepted.");
...
console.log("Protocol discovery checks passed: document rejection, protocol resolution, Etherscan host trust, verified-source validation, proxy implementation handoff, source analysis, and fail-closed promotion.");
